...
$(function() {
    ...
    if (sr.isSupported()) {
        ...
        sr.reveal('.GRACESS_Company_Class', {
            distance: '15px',
            origin: 'top'
        });
        sr.reveal('.Text_cb_Class', {
            distance: '15px',
            origin: 'top',
            delay: 400,
        });
        ...
        sr.reveal('.Enter_your_Email_Class, .Text_b_Class', {
            distance: '15px',
            origin: 'top',
            delay: 800,
        });
        ...
        sr.reveal('.n___ce_Class', {
            distance: '15px',
            origin: 'top',
        });
        sr.reveal('.About_Us_Class', {
            distance: '15px',
            origin: 'top',
            afterReveal: function() { $(".Line_21").show(400) }
        });
        sr.reveal('.Text_cic_Class, .n__cid_Class', {
            distance: '15px',
            origin: 'top',
            delay: 400,
        });
        sr.reveal('.n__cie_Class', {
            distance: '15px',
            origin: 'top',
            delay: 800,
        });
        sr.reveal('.Group_279_Class', {
            distance: '15px',
            origin: 'top',
            delay: 1200,
        });
        sr.reveal('.Mask_Group_62_Class', {
            distance: '15px',
            origin: 'bottom',
        });
        sr.reveal('.Group_317_Class, .Group_318_Class, .Group_319_Class, .Group_320_Class', {
            distance: '15px',
            origin: 'top',
        });
        sr.reveal('.Path_2542', {
        ...
        sr.reveal('.Our_Partner_Class, .n__cia_Class, .n__ch_Class', {
            distance: '15px',
            origin: 'top',
            delay: 800,
        });
